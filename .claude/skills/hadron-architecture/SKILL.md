...
- **hadron-libc**: POSIX compatibility shim translating libc calls to native Hadron syscalls (260/268 libc-test passing). Secondary layer for porting existing POSIX applications
