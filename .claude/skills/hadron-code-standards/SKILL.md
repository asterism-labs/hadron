...
- New userspace code should prefer the native `lepton-syslib` API over POSIX wrappers
- `lepton-syslib` is the primary userspace interface; `hadron-libc` is a secondary compatibility layer
