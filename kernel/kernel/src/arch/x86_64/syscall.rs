...
hadron_core::percpu_static!(pub static SYSCALL_SAVED_REGS: SyncSavedRegs = SyncSavedRegs::new());
...
/// Syscall dispatch — routes to the central dispatch table.
///
...
extern "C" fn syscall_dispatch(
    ...
    crate::syscall::dispatch(nr, a0, a1, a2, a3, a4)
}
