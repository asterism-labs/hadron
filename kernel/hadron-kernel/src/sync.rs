...
//!
//! Re-exports from [`hadron_core::sync`] and provides additional
//! kernel-specific synchronization utilities.
...
pub use hadron_core::sync::{
    IrqSpinLock, IrqSpinLockGuard, LazyLock, Mutex, MutexGuard, MutexLockFuture, RwLock,
    RwLockReadGuard, RwLockWriteGuard, SpinLock, SpinLockGuard, WaitQueue,
};

/// Heap-backed wait queue with unbounded capacity.
///
/// Unlike the frame-layer [`WaitQueue`] (fixed 32 slots), this uses
