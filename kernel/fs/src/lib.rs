...
impl FsError {
    ...
    pub fn to_errno(self) -> isize {
        match self {
            FsError::NotFound => hadron_syscall::ENOENT,
            FsError::NotADirectory => hadron_syscall::ENOTDIR,
            FsError::IsADirectory => hadron_syscall::EISDIR,
            FsError::AlreadyExists => hadron_syscall::EEXIST,
            FsError::BadFd => hadron_syscall::EBADF,
            FsError::PermissionDenied => hadron_syscall::EACCES,
            FsError::IoError => hadron_syscall::EIO,
            FsError::InvalidArgument => hadron_syscall::EINVAL,
