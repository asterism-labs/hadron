...
//!
//! Provides cooperative yielding and async combinators for kernel tasks.
//! Timer-based sleeping (`sleep_ticks`, `sleep_ms`) stays in the kernel
//! because it depends on `time::timer_ticks()`.
