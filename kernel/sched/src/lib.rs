...
//! between awaits.
//!
//! This crate contains the core executor, timer queue, waker, and
//! scheduling primitives. Architecture-specific code (IPI wakeup,
//! HLT/WFI, work stealing routing) is injected from the kernel glue
//! layer via trait implementations and registered callbacks.
